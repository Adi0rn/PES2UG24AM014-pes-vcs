...
```
PES_AUTHOR="Adithya Ajith Pillai <PES2UG24AM014>"
```
...
GitHub Repository: https://github.com/SunOrangeBurger/PES2UG24AM014-pes-vcs
...
```bash
export PES_AUTHOR="Adithya Ajith Pillai <PES2UG24AM014>" && ./pes [command]
```
...
**Signature:** Adithya Ajith Pillai  
**Date:** 17/4/2026
